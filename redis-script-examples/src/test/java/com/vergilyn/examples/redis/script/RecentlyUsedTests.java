...
import static com.vergilyn.examples.redis.cache.RecentlyUseCache.SCRIPT_PATH;
...
public class RecentlyUsedTests extends AbstractJedisClientTest {
	...
	@Test
	public void valid(){
		String lua = LuaScriptReadUtils.getScript(SCRIPT_PATH);
		...
		Long result1 = _stringRedisTemplate.execute(script, keys, args1.toArray());
		...
		Long result2 = _stringRedisTemplate.execute(script, keys, args2.toArray());
		...
		Long result3 = _stringRedisTemplate.execute(script, keys, args3.toArray());
		...
		Long result4 = _stringRedisTemplate.execute(script, keys, args4.toArray());
