...
public interface RecentlyUseCache<T extends AbstractIntegerEntity> {
	String SCRIPT_PATH = "/lua/recently-used-write.lua";

	/**
	 * “最近使用”
	 * <pre>
	 *   KEYS[1]:
	 * 	 ARGV[1]: fixed-size, 固定sort-set大小
	 * 	 ARGV[2]: expired (s), KEYS[1]失效时间
	 *   ARGV[3]: score
	 * 	 ARGV[4+]: members
	 * </pre>
	 *
	...
	default String getScript(){
		return LuaScriptReadUtils.getScript(SCRIPT_PATH);
	}
