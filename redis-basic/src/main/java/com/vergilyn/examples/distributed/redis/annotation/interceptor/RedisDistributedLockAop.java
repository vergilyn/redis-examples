package com.vergilyn.examples.distributed.redis.annotation.interceptor;

import java.lang.annotation.Annotation;
import java.lang.reflect.Method;
import java.util.concurrent.TimeUnit;

import com.vergilyn.examples.distributed.redis.annotation.RedisDistributedLock;
import com.vergilyn.examples.distributed.redis.annotation.RedisLockedKey;
import com.vergilyn.examples.distributed.redis.redis.RedisLock;
import com.vergilyn.examples.distributed.redis.redis.exception.RedisLockException;
...
public class RedisDistributedLockAop {
     ...
     * 定义缓存逻辑
     */
    @Around("@annotation(com.vergilyn.examples.distributed.redis.annotation.RedisDistributedLock)")
