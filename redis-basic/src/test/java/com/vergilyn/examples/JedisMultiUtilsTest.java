...
public class JedisMultiUtilsTest {
	...
	public void mgetSort() {
		Map<String, List<String>> allList = JedisMultiUtils
				.mgetSort(new String[] { KEY_SORT + 1, KEY_SORT + 2, KEY_SORT + "X" }, 0, -1, String.class,
	...
	public void mgetSet() {
		Map<String, List<String>> allList = JedisMultiUtils
				.mgetSet(new String[] { KEY_SET + 1, KEY_SET + 2, KEY_SET + "X" }, String.class,
						new RedisMultiAbstract<List<String>>() {
							@Override
							public List<String> emptySet(String key) {
								List<String> xx = Lists.newArrayList();
	...
	public void mgetListLrange() {
		Map<String, List<String>> allList = JedisMultiUtils
				.mgetListLrange(new String[] { KEY_LIST + 1, KEY_LIST + 2, KEY_LIST + "X" }, 0, 1, String.class,
						new RedisMultiAbstract<List<String>>() {
							@Override
							public List<String> emptySet(String key) {
								List<String> xx = Lists.newArrayList();
	...
	public void mgetFieldsHash() {
		Map<String, Map<String, String>> allHash = JedisMultiUtils
				.mgetHash(new String[] { KEY_HASH + 1, KEY_HASH + 2, KEY_HASH + "X" },
	...
	public void mgetAllHash() {
		Map<String, Map<String, String>> allHash = JedisMultiUtils
				.mgetHash(new String[] { KEY_HASH + 1, KEY_HASH + 2, KEY_HASH + "X" }, null,
						new RedisMultiAbstract<Map<String, String>>() {
							@Override
							public Map<String, String> emptySet(String key) {
								Map<String, String> map = new HashMap<>();
	...
	public void mgetString() {
		Map<String, String> allHash = JedisMultiUtils
				.mgetString(new String[] { KEY_STRING + "1", KEY_STRING + "2", KEY_STRING + "X" }, String.class,
						new RedisMultiAbstract<String>() {
							@Override
