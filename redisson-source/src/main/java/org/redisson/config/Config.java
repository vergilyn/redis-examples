...
public class Config {
     ...
     * own threads and each Redisson template creates own EventLoopGroup by default.
     ...
     * <p>  
     * This prevents against infinity locked locks due to Redisson template crush or
