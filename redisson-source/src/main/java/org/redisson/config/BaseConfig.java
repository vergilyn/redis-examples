...
class BaseConfig<T extends BaseConfig<T>> {
    ...
    /**
     * Redis server response timeout. Starts to countdown when Redis command was successfully sent. <br/>
     * Redis服务器响应超时. 当Redis命令成功发送时开始倒计时. <br/>
     * Value in milliseconds.
     *
     */
     ...
     *
     * @param clientName - name of template
     * @return config
     */
